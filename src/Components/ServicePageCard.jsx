...
const ServicePageCard = ({ eachServiceData }) => {
    return (
            ...
            <div className="px-4 sm:px-5 md:px-5">
                ...
                <div className='flex justify-between items-center mb-4 sm:mb-6'>
                    <p className='text-xl sm:text-2xl md:text-2xl font-semibold text-[#2E3A2E]'>
                        ${eachServiceData.price}
                    </p>
                    <div>
                        {eachServiceData.rating === 5 && <p className='text-yellow-500'>⭐⭐⭐⭐⭐</p>}
                        {eachServiceData.rating === 4 && <p className='text-yellow-500'>⭐⭐⭐⭐</p>}
                    </div>
                </div>
                <div className="card-actions justify-end">
                    <Link to={`/home/${eachServiceData.serviceId}`}>
                        <button
