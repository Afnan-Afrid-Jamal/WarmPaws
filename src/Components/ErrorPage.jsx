    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <main className="flex-1 flex flex-col items-center justify-center text-center px-4">
                <FaExclamationTriangle className="text-6xl text-red-500 mb-6 animate-ping" />
                ...
                <Link
                    ...
                    className="btn flex items-center mt-3 gap-2 bg-gradient-to-r from-[#E59560] to-[#F28C4C] text-white 
                                       ...
                                       transition-all duration-300 transform hover:scale-105 animate-pulse hover:animate-none"
                >
                    Go Back Home
                </Link>
            </main>
